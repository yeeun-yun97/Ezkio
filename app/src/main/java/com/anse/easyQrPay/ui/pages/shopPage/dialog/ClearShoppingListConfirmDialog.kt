...
@Composable
fun ClearShoppingListConfirmDialog(
    ...
    Dialog(
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    stringResource(
                        R.string.shop_page_clear_shopping_list_confirm_dialog_title
                    ),
                    fontSize = 16.sp,
                ...
                Text(
                    stringResource(
                        R.string.shop_page_clear_shopping_list_confirm_dialog_message
                    ),
                    fontSize = 14.sp,
